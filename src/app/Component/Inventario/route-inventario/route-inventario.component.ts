...
@Component({
  ...
  templateUrl: './route-inventario.component.html',
  styleUrls: ['./route-inventario.component.css']
})
export class RouteInventarioComponent implements OnInit {
  ...
  reedirecciona(){
    ...
    this.router.navigate(['/app/detalle-inventarios',this.value]);
