...
@Component({
  moduleId: module.id,
  selector: 'listado-detalle-inventarios',
  templateUrl: './listado-detalle-inventarios.html',
  styleUrls: ['./listado-detalle-inventarios.css']

})

export class ListadoDetalleInventariosComponent {
